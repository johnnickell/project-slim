...
A new Slim starter project needs governed boundaries: explicit Fight Common container definitions, routes, middleware, handlers, HTTP, and presentation composition. Fight Common and Fight AccessControl must remain public Composer packages only.
